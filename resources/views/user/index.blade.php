                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="text-center p-4">
                                            ...
                                            <p class="text-white-50 font-size-13">klfv fvjfv fvjfv fvrfv fvfv fvfv</p>
                                            <a href="#" target="_blank" type="button" class="btn btn-light btn-sm">View details <i class="mdi mdi-arrow-right ms-1"></i></a>
                                        </div>
                                    </div>
                                    <!-- end carousel-item -->
                                    <div class="carousel-item">
                                        <div class="text-center p-4">
                                            ...
                                            <p class="text-white-50 font-size-13">jf fvjfvfvf vfjvfv rvjkjfv fvjfvf </p>
                                            <a href="#" target="_blank" type="button" class="btn btn-light btn-sm">View details <i class="mdi mdi-arrow-right ms-1"></i></a>
                                        </div>
                                    </div>
                                    <!-- end carousel-item -->
