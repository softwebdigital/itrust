...
@section('content')
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="text-center p-4">
                                            ...
                                            <p class="text-white-50 font-size-13">{!! $btcNews['results'][0]['title'] !!}</p>
                                            <a href="{{ $btcNews['results'][0]['link'] }}" target="_blank" type="button" class="btn btn-light btn-sm">View details <i class="mdi mdi-arrow-right ms-1"></i></a>
                                        </div>
                                    </div>
                                    <!-- end carousel-item -->
                                    <div class="carousel-item">
                                        <div class="text-center p-4">
                                            ...
                                            <p class="text-white-50 font-size-13">{!! $ethNews['results'][0]['title'] !!} </p>
                                            <a href="{{ $ethNews['results'][0]['link'] }}" target="_blank" type="button" class="btn btn-light btn-sm">View details <i class="mdi mdi-arrow-right ms-1"></i></a>
                                        </div>
                                    </div>
                                    <!-- end carousel-item -->
                                    <div class="carousel-item">
    ...
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Market Cap</h4>
